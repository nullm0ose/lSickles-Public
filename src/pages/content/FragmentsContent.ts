...
"And it is the title I carry with the most pride.",
    ...
    "They said the world",
"was an oyster,",
"as if I only needed patience",
"and the right hands",
"to pry it open.",
"",
"So I dove.",
"",
"But the ocean offered sand.",
"Endless grit.",
"",
"No treasure waiting",
"beneath numb fingers.",
"",
"Life is water",
"washing the same shore",
"again and again,",
"rounding stones",
"until even their edges forget",
"how they once cut.",
"",
"They promised pearls",
"to make the dive worth it.",
"",
"That somewhere inside the shell",
"waited something luminous.",
"",
"To soften the ache",
"of searching.",
"",
"But when I cracked the shells",
"I carried back to land,",
"",
"there was only salt,",
"and the small hard grain",
"that started it all."
    ],
  },
];